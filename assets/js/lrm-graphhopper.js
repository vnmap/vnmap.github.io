			...
			(function () {
				...
				L.Routing.GraphHopper = L.Evented.extend({
					...
					_getVehicle: function () {
						var carVehicle = L.DomUtil.get('carVehicle')
						if (L.DomUtil.hasClass(carVehicle, 'selected')) {
							this._vehicle = 'car'
							return;
						}
						var footVehicle = L.DomUtil.get('footVehicle')
						if (L.DomUtil.hasClass(footVehicle, 'selected')) {
							this._vehicle = 'foot'
							return;
						}
						var bikeVehicle = L.DomUtil.get('bikeVehicle')
						if (L.DomUtil.hasClass(bikeVehicle, 'selected')) {
							this._vehicle = 'bike'
							return;
						}
					},
